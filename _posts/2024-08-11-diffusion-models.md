...
----------------------------------------
Let $\big(\widehat{X}_{\theta} (t)\big)$ be X the solution to the SDE (12) with $s$ replaced by $s_\theta$ for fixed $\theta \in \Theta$ and random initilisation $\mathcal{N}(0, \Sigma(T))$.
